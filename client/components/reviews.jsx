    ...
    <>
      <div className="col-12 scale bottom">
        <div className="d-flex justify-content-center align-items-center flex-column">
          ...
          <img className="w-50 h-50 shadowed-text" src="/images/reviews.png" alt="image of stars"></img>
        </div>
      </div>
      <div className='col-sm-9 col-md-11 col-lg-10 mt-5 container text-center'>
        <Slider className={'text-white'} {...settings}>
          ...
          <div>
            ...
            <br></br><br></br><span className={'text-center'}><h3>Rich Mraules</h3></span></h3>
          </div>
        </Slider>
      </div>
    </>
